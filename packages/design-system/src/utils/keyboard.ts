 ...
 */
export function createKeyHandler(keys: string[], handler: KeyboardHandler): KeyboardHandler {
 ...
 */
export function createActivationHandler(handler: KeyboardHandler): KeyboardHandler {
 ...
 */
export function createArrowKeyHandler(handler: KeyboardHandler): KeyboardHandler {

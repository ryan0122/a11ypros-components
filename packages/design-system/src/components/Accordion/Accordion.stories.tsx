...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'An accessible accordion component built with native HTML5 details/summary elements. Supports keyboard navigation and screen readers with proper ARIA attributes.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  render: () => (
    <Accordion>
      <AccordionItem id="item-1" title="What is accessibility?">
        <p>
          Accessibility (often abbreviated to a11y) is the practice of making your websites usable
          by as many people as possible. This includes people with disabilities, people using mobile
          devices, and people with slow network connections.
        </p>
      </AccordionItem>
      <AccordionItem id="item-2" title="Why is accessibility important?">
        <p>
          ...
          services. It's also legally required in many jurisdictions.
        </p>
      </AccordionItem>
      <AccordionItem id="item-3" title="How do I make my site accessible?">
        <p>
          ...
          provide proper ARIA labels, ensure keyboard navigation works, maintain sufficient color
          contrast, and test with screen readers.
        </p>
      </AccordionItem>
    </Accordion>
  ),
  ...
  render: () => (
    <Accordion>
      <AccordionItem id="item-1" title="Getting Started" defaultOpen>
        <p>This section is open by default. Click the header to collapse it.</p>
      </AccordionItem>
      ...
      <AccordionItem id="item-3" title="Configuration">
        <p>Configure the component according to your needs.</p>
      </AccordionItem>
    </Accordion>
  ),
};
  ...
  render: () => (
    <Accordion>
      <AccordionItem id="item-1" title="Introduction to WCAG">
        <p>
          <strong>Web Content Accessibility Guidelines (WCAG)</strong> is developed through the W3C
          process in cooperation with individuals and organizations around the world.
        </p>
        <p>
          The goal of WCAG is to provide a single shared standard for web content accessibility that
          meets the needs of individuals, organizations, and governments internationally.
        </p>
      </AccordionItem>
      <AccordionItem id="item-2" title="WCAG Principles">
        ...
        <ol>
          ...
          <li>
            <strong>Understandable</strong> - Information and the operation of user interface must
            be understandable.
          </li>
          <li>
            <strong>Robust</strong> - Content must be robust enough that it can be interpreted
      ...
      <AccordionItem id="item-3" title="Conformance Levels">
        <ul>
          <li>
            <strong>Level A</strong> - Minimum level of conformance
          </li>
          <li>
            <strong>Level AA</strong> - Recommended level (most common target)
          </li>
          <li>
            <strong>Level AAA</strong> - Highest level of conformance
          </li>
        </ul>
        <p>

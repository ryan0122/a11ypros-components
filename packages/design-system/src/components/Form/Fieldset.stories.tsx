...
export const HiddenLegend: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Legend is visually hidden but still accessible to screen readers. Use when visual grouping is obvious but you want to maintain semantic structure.',
      },
    },
  },
};
...
export const WithRadioButtons: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Fieldset is essential for grouping radio buttons. The Radio component uses fieldset internally, but you can wrap multiple radio groups in a fieldset for higher-level grouping.',
      },
    },
  },
};
...
export const WithCheckboxes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Fieldset groups related checkboxes together, providing context about what the checkboxes are for.',
      },
    },
  },
};

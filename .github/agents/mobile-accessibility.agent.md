...
handoffs:
  - label: "Web Accessibility Audit"
    ...
    prompt: "The mobile audit is complete. Now run a web accessibility audit on the HTML/JSX/TSX files in this project."
  - label: "Design System Audit"
    agent: design-system-auditor
    prompt: "Check whether the design tokens driving this mobile UI have sufficient contrast and compliant touch target spacing."
---

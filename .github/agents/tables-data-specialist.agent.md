...
handoffs:
  - label: "Full Web Audit"
    ...
    prompt: "Data table review complete. Run a full accessibility audit covering ARIA, keyboard, contrast, forms, and all other WCAG dimensions."
  - label: "Keyboard Navigation Review"
    agent: keyboard-navigator
    prompt: "Verify keyboard navigation within this data grid or sortable table - check arrow key patterns and focus management."
---

...
handoffs:
  - label: "Run axe-core Scan"
    agent: accessibility-lead
    prompt: "Testing plan established. Now run a full accessibility audit of the code to find issues to test against."
  - label: "Keyboard Testing Walkthrough"
    agent: keyboard-navigator
    prompt: "Walk me through verifying keyboard navigation for each interactive component on this page."
---

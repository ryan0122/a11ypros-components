---
name: github-central
description: Your intelligent GitHub command center. Discovers repos and organizations, understands plain English goals, orchestrates all GitHub workflow agents.
mode: agent
agent: github-hub
tools:
  - askQuestions
...
# GitHub Hub - Your Command Center

Start here for any GitHub workflow task. No commands to memorize - just describe what you need.
